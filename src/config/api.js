...
export const API_ENDPOINTS = {
  ...
  TEACHER_QUESTION_QUALITY: (topic, forceRefresh = false) => `${AUTH_MINI_BASE}/teacher/analytics/question-quality?topic=${encodeURIComponent(topic)}${forceRefresh ? '&force_refresh=true' : ''}`,
