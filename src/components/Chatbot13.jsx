...
//     setIsQuizOpen(true);
//     setApiUrl("https://mba.ptit.edu.vn/api/random-questions"); // Set the API URL when opening the quiz
//   };
...
//       try {
//         const response = await fetch(`https://mba.ptit.edu.vn/rag_api/tonghop/?time=${timestamp}&q=${inputMessage}`, {
//           method: "get",
//           headers: new Headers({
...
const Chatbot1 = ({
  ...
  const handleOpenQuiz = () => {
    ...
    setApiUrl("https://mba.ptit.edu.vn/api/random-questions");
  };
