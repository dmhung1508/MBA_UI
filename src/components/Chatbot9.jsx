...
const Chatbot1 = ({
  ...
  const handleOpenQuiz = () => {
    ...
    setApiUrl("https://mba.ptit.edu.vn/api/random-questions?topic=15_qtdnsl");
  };
  ...
  const handleSendMessage = async () => {
    if (inputMessage.trim() !== "" && !isLoading) {
      ...
      try {
        const response = await fetch(`https://mba.ptit.edu.vn/rag_api/rag/?time=${username}&q=${encodeURIComponent(inputMessage)}&source=quantridoanhnghiepsieulon`, {
          method: "GET",
          headers: new Headers({
