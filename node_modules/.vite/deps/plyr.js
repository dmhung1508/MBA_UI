...
var Fullscreen = class _Fullscreen {
  constructor(e) {
    _defineProperty$1(this, "onChange", () => {
      ...
      else if (!_Fullscreen.nativeSupported || this.forceFallback) this.toggleFallback(false);
      else if (this.prefix) {
  ...
  get active() {
    ...
    if (!_Fullscreen.nativeSupported || this.forceFallback) return hasClass(this.target, this.player.config.classNames.fullscreen.fallback);
